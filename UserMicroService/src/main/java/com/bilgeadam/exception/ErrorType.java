...
public enum ErrorType {
    ...
    COMPANY_ALREADY_EXIST(4123, "Şirket zaten kayıtlıdır.", HttpStatus.BAD_REQUEST),
    COMPANY_NOT_FOUND(4124,"Şirket bulunamadı.", HttpStatus.BAD_REQUEST),
    NOT_AUTHORIZED(4125, "Bu işlemi yapma yetkiniz yoktur.", HttpStatus.BAD_REQUEST);
